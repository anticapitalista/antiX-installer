...
nem egyeznek. Próbáld meg újra.</translation>
    ...
    <message>
        ...
        <translation>&lt;p&gt;&lt;b&gt;Segítség Szerzése&lt;/b&gt;&lt;br/&gt;A antiX-ről alapinformációk a a http://antix.mepis.com oldalon találhatók, valamint önkéntesek is segítenek probléma estén a antiX Fórumon, http://antix.freeforums.org&lt;/p&gt;&lt;p&gt;Ha segítséget kérsz, emlékezz hogy a problámát a problémád és számítógéped valamennyi szükséges részletével együtt írd le. Az &apos;ez nem működik&apos; típusú kijelentések általában nem segítenek a probléma megoldásában.&lt;/p&gt;</translation>
    </message>
    <message>
...
sure you want to Close now?</source>
    ...
    <message>
        ...
        <translation>Asztali tűzfal</translation>
    </message>
    <message>
...
Válassz egy másik nevet mielőtt folytatnád.</translation>
    ...
    <message>
        ...
        <translation>title %1 az %2 -n</translation>
    </message>
    <message>
...
Biztos meg akarod állítani a folyamatot?</translation>
    ...
    <message>
        ...
        <translation>title antiX az %1 -n, az előző kernellel (ha van)
</translation>
    </message>
    <message>
...
hosszabb jelszót mielőtt folytatnád.</translation>
    ...
    <message>
        ...
        <translation>modemes, adsl és pptp támogatás</translation>
    </message>
    <message>
...
másik nevet mielőtt folytatnád.</translation>
    ...
    <message>
        ...
        <translation>Bluetooth vezetéknélküli eszköz támogatás</translation>
    </message>
    <message>
...
egy másik nevet mielőtt folytatnád.</translation>
    ...
    <message>
        ...
        <translation>&lt;p&gt;&lt;b&gt;Válassz Indítási Módot&lt;/b&gt;&lt;br/&gt;A antiX a GRUB bootmenedzsert használja a antiX és MS-Windows rendszerek indításához. Ha egyéb Linux verziók is vannak a számítógépeden, akkor a GRUB nem lesz automatikusan beállítva az elindításukhoz. A /boot/grub/menu.lst fájlba neked kell majd egyénileg beírni azokat a rendszereket.&lt;/p&gt;&lt;p&gt;Ha ide telepíted a GRUB-ot, akkor az az elsődleges merevlemez MBR részébe lesz írva, ahol felül fogja írni az előzőleg használt egyéb bootmenedzsert. Ez normális.&lt;/p&gt;&lt;p&gt;Ha az MBR helyett a root-ot választod a GRUB helyéül, akkor a GRUB a root partíció elejébe lesz telepítve. A legtöbb esetben ez lehetővé teszi a GRUB indítását egy harmadik fél által biztosított bootmenedzserből. Ez az opció csak szakértőknek ajánlott.&lt;/p&gt;&lt;p&gt;Az &apos;initrd használata&apos; opció lehetővé teszi az initrd nevű speciális szoftver számára, hogy előre betöltsőn néhány extra illesztőt, visszahozza a számítógépet a hibernálás funkcióból, és hogy hamarabb elindítsa a grafikus indítás funkciót. Használata javasolt, de nem szükségszerű. &lt;/p&gt;&lt;p&gt;Ha nem pipálod be a &apos;GRUB telepítése&apos; dobozt, akkor a GRUB nem lesz föltelepítve ezalkalommal. A GRUB a későbbiekben a &apos;GRUB újratelepítése&apos; funkcióval telepíthető, mely a MEPIS Segédekben található. A &apos;GRUB újratelepítése&apos; lehetőséget ad a GRUB floppyra való telepítésére is.&lt;/p&gt;</translation>
    </message>
    <message>
...
with php and perl support</source>
        <translation>Helyi web szerver php
és perl támogatással</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>title antiX az %1 -n, %2 kernellel
</translation>
    </message>
    <message>
...
egyeznek. Próbáld meg újra.</translation>
    ...
    <message>
        ...
        <translation>&lt;p&gt;&lt;b&gt;Általános Útmutatók&lt;/b&gt;&lt;br/&gt;MIELŐTT FOLYTATNÁD, ZÁRD BE AZ ÖSSZES EGYÉB ALKALMAZÁST. HA A 3D ASZTALT HASZNÁLOD, JAVASOLT A KIJELENTKEZÉS ÉS A SIMA KDE ASZTALRA VALÓ ÚJBÓLI BEJELENTKEZÉS.&lt;/p&gt;&lt;p&gt;Mindegyik oldalon olvasd el az útmutatókat, válaszd ki a megfelelő beállításokat, majd nyomd meg a Tovább gombot mikor kész vagy. Mindennemű destruktív művelet előtt a beleegyezésed ki lesz kérve.&lt;/p&gt;&lt;p&gt;A antiX &apos;könnyű&apos;, szimpla verziója kb. 1,2 GB szabad helyet igényel, még a bővebb verzió 2 GB-ot. 5 GB vagy annál több rendelkezésre álló hely javasolt. Az egész lemezt is fölhasználhatod vagy már meglévő partíciókra is telepítheted a antiX-t.&lt;/p&gt;&lt;p&gt;Ha PC típusú hardvert használsz, akkor futtasd innen a GParted alkalmazást, ha módosítanod kell néhány partíciót az egyéni telepítés előtt. Ha Apple típusú hardvert használsz, soha ne használd a GParted vagy parted alkalmazást a boot lemezeden. Ehelyett használd az OSX alkalmazásait a partíciók beállítására illetve az OSX bootmenedzserét a antiX telepítése előtt. A SimplyMEPIS Segéd egy, a CD-n elérhető OSX program, ami segít előkészíteni az OSX boot lemezt a antiX telepítéséhez.&lt;/p&gt;&lt;p&gt;Az ext3, ext4, és reiserfs fájlrendszerek vannak támogatva, amelyek közül az ext4 az ajánlott.&lt;/p&gt;&lt;p&gt;&lt;b&gt;Partíció követelmények&lt;/b&gt;&lt;br/&gt;Egy linux-swap partíció erősen javasolt. A RAM + swap memóriának legalább 128 MB-nak kell lennie. A nagyobb méretű swap növelheti a rendszer teljesítményét, de nincs szükség 512 MB-nál nagyobbra, hacsak nem fejlesztesz szoftvert vagy nem vágsz videókat, vagy esetleg nem futtatsz adatbázis szervert.&lt;/p&gt;&lt;p&gt;Egy kölönálló /home (home) partíció javasolt, melynek legalább 200 MB méretűnek kell lennie, de a lehető legnagyobb a javallt. Ez az a hely, ahol a munkád el lesz mentve. Egy különálló home partíció könnyebbé teszi a jövőbeni mentéseket valamint antiX frissítéseket és újratelepítéseket. Egy linux / (root) partíció is szükséges, melynek 800 MB méretűnek kell lennie a antiX &apos;könnyű&apos;, szimpla verziója estén, még a bővebb verzió esetén 1,3 GB javallt. Ha nincs különálló /home partíciód, akkor 2,5 GB-nál is nagyobb partícióra lesz szükség. A root lesz a további alkalmazások tárhelye, valamint a Linux kernel és illesztők is itt lesznek befordítva. Ha sok programot fogsz telepíteni és/vagy tesztelni, akkor nagyobbra kell szabni a root partíciót. Hacsak nem tesztelsz igen sok programot, nem valószínű, hogy 4 GB-nál nagyobbra kell a root-ot méretezni.&lt;/p&gt;&lt;p&gt;&lt;b&gt;Automatikus Telepítés az Egész Lemez Felhasználásával&lt;/b&gt;&lt;br/&gt;A kiválasztott lemez teljesen meg lesz formázva és a telepítő a antiX igényei szerint megpartícionálja azt. Tetszőlegesen a lemez egy részének a szabadon hagyását is kérheted, hogy pl. később egy második operációs rendszert is feltelepíthess.&lt;/p&gt;&lt;p&gt;&lt;b&gt;Egyéni Telepítés Meglévő Partíciókra&lt;/b&gt;&lt;br/&gt;A antiX az általad választott meglévő partíciókra lesz telepítve. Ha a merevlemez nem megfelelően van partícionálva, akkor itt és most módosíthatod azokat a GParted segítségével. NE használd a GParted vagy parted alkalmazásokat, ha Apple típusú számítógép boot lemezére telepítesz.&lt;/p&gt;&lt;p&gt;&lt;b&gt;Frissítés&lt;/b&gt;&lt;br/&gt;Egy meglévő Linux frissítése esetén válaszd az &apos;egyéni telepítés meglévő partíciókra&apos; opciót, majd az &apos;adatok meghagyása a /home-ban&apos; funkciót.&lt;/p&gt;</translation>
    </message>
    <message>
...
Visszatérés az 1. lépéshez.</translation>
    ...
    <message>
        ...
        <translation>A GRUB feltelepült.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>title antiX az  %1 -n, a legújabb kernellel
</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>A számítógép órája GMT-re van állítva</translation>
    </message>
    <message>
        <source>Abort</source>
    ...
    <source>&lt;p&gt;antiX is an independent linux distribution based on Debian Testing and MEPIS Linux.&lt;/p&gt; &lt;p&gt;antiX uses some components from MEPIS Linux which are released under an Apache free license. Some MEPIS components have been modified for antiX. Please be aware of the MEPIS copyright. The MEPIS product names and the MEPIS logos are trademarks of MEPIS LLC. Commercial use of MEPIS products and/or marks is prohibited unless permission is obtained in writing.&lt;/p&gt; &lt;p&gt;Enjoy using antiX.&lt;/p&gt;</source>
        <translation>&lt;p&gt;Antix egy független Linux-disztribúció Debian alapú tesztelés és MEPIS Linux.&lt;/p&gt; &lt;p&gt;Antix használ néhány összetevőket MEPIS Linux amelyek alatt kiadott Apache szabad licenc. Néhány MEPIS elemek módosításra kerültek a Antix. Kérjük, vegye figyelembe a MEPIS szerzői. A MEPIS termék nevét és a MEPIS emblémák a MEPIS LLC. Kereskedelmi felhasználása MEPIS termékek és / vagy jelek tilos, kivéve, ha engedélyt kapunk írásban.&lt;/p&gt; &lt;p&gt;Szívesen használja Antix.&lt;/p&gt;</translation>
    </message>
    <message>
        <source>&lt; Back</source>
    ...
    <message>
        ...
        <translation>GParted indítása...</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Elolvastam az Általános Szerződési Feltételeket</translation>
    </message>
    <message>
        <source>&lt;p&gt;&lt;b&gt;Support antiX&lt;/b&gt;&lt;br/&gt;antiX is supported by people like you. Some help others at the support forum - http://antix.freeforums.org, or translate help files into different languages, or make suggestions, write documentation, or help test new software.&lt;/p&gt;</source>
        <translation>&lt;p&gt;&lt;b&gt;Támogasd a antiX-t&lt;/b&gt;&lt;br/&gt;antiX-t olyan emberek támogatják, mint te. Néhányan a http://antix.freeforums.org fórumon keresztül segítenek másokat, mások fájlokat fordítanak más nyelvekre, javaslatokat tesznek, dokumentációt írnak, vagy éppen az új szofvert tesztelik.&lt;/p&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>initrd használata (ajánlott)</translation>
    </message>
    <message>
