...
**
** Created: Tue Jan 24 21:21:04 2012
...
public:
    ...
    void setupUi(QWidget *MeInstall)
    {
        ...
        agreeCheckBox = new QCheckBox(copyrightBox);
        ...
        sizePolicy2.setHeightForWidth(agreeCheckBox->sizePolicy().hasHeightForWidth());
        agreeCheckBox->setSizePolicy(sizePolicy2);

        gridLayout2->addWidget(agreeCheckBox, 1, 0, 1, 1);
        ...
        initrdCheck = new QCheckBox(bootMethodGroup);
        initrdCheck->setObjectName(QString::fromUtf8("initrdCheck"));
        sizePolicy2.setHeightForWidth(initrdCheck->sizePolicy().hasHeightForWidth());
        initrdCheck->setSizePolicy(sizePolicy2);
        initrdCheck->setChecked(true);

        gridLayout14->addWidget(initrdCheck, 3, 1, 1, 3);
        ...
        gridLayout22->addItem(spacerItem10, 3, 0, 1, 1);
        ...
        QWidget::setTabOrder(copyrightBrowser, agreeCheckBox);
        QWidget::setTabOrder(agreeCheckBox, backButton);
        ...
        QWidget::setTabOrder(grubRootButton, grubBootCombo);
        QWidget::setTabOrder(grubBootCombo, initrdCheck);
        QWidget::setTabOrder(initrdCheck, csView);
        ...
        QWidget::setTabOrder(rootPasswordEdit2, passwordCheckBox);
        QWidget::setTabOrder(passwordCheckBox, remindersBrowser);
        ...
        QObject::connect(grubCheckBox, SIGNAL(toggled(bool)), grubRootButton, SLOT(setEnabled(bool)));
        QObject::connect(grubCheckBox, SIGNAL(toggled(bool)), grubMbrButton, SLOT(setEnabled(bool)));
        QObject::connect(grubCheckBox, SIGNAL(toggled(bool)), initrdCheck, SLOT(setEnabled(bool)));
    ...
    void retranslateUi(QWidget *MeInstall)
    {
        ...
        initrdCheck->setShortcut(QApplication::translate("MeInstall", "Alt+X", 0, QApplication::UnicodeUTF8));
        ...
        computerGroupEdit->setText(QApplication::translate("MeInstall", "antiXgrp", 0, QApplication::UnicodeUTF8));
        ...
        computerNameEdit->setText(QApplication::translate("MeInstall", "antiX1", 0, QApplication::UnicodeUTF8));
        ...
        gmtCheckBox->setText(QApplication::translate("MeInstall", "System clock uses GMT", 0, QApplication::UnicodeUTF8));
        ...
        userNameEdit->setText(QApplication::translate("MeInstall", "username", 0, QApplication::UnicodeUTF8));
